...
@section('css')
    @toastr_css
@section('title')
    {{trans('main-translation.List_Teachers')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('teacher.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{ trans('teacher-translation.add_teacher') }}</a><br><br>
                                        ...
                                        @foreach($teachers as $teacher)
                                            ...
                                            <td>{{$teacher->specializations->name}}</td>
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_Teacher{{ $teacher->id }}" title="{{ trans('grade-translation .delete') }}"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('teacher-translation.delete_teacher') }}</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p> {{ trans('class-translation.Warning_Grade') }}</p>
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit"
                                                                        class="btn btn-danger">{{ trans('teacher-translation.delete') }}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </form>

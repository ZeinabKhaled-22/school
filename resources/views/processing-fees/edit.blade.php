...
@section('css')
    @toastr_css
@section('title')
  {{ trans('proccessing-fee-translation.edit_proccessing_fee') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{ trans('proccessing-fee-translation.edit_proccessing_fee') }}  : <label style="color: red">{{$processingFee->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')

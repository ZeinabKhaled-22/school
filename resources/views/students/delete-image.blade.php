    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('student-translation.delete_attachment')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('delete_attachment')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('student-translation.delete_attachment_title')}}</h5>

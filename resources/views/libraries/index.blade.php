...
@section('css')
    @toastr_css
@section('title')
    {{ trans('library-translation.list_book') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('library.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{ trans('library-translation.add_book') }}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('library-translation.title') }}</th>
                                            <th>{{ trans('library-translation.teacher_name') }}</th>
                                            <th>{{ trans('library-translation.grade_name') }}</th>
                                            <th>{{ trans('library-translation.classroom_name') }}</th>
                                            <th>{{ trans('library-translation.section_name') }}</th>
                                            <th>{{ trans('library-translation.proccess') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>

...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{ trans('question-translation.question_list') }} : <span class="text-danger">{{$quizz->name}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('questions.show',$quizz->id)}}" class="btn btn-success btn-sm" role="button" aria-pressed="true">{{ trans('question-translation.add_question') }}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @include('teachers.dashboard.question.delete')
                                        @endforeach
                                    </table>
                                </div>
                            </div>

...
@section('css')
    @toastr_css
@section('title')
    {{trans('main-translation.list_students')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-info">{{trans('student-translation.name')}}</th>
                                        ...
                                        @include('students.promotions.delete-all')
                                        @include('students.promotions.delete-one')
                                        @endforeach
                                    </table>
                                </div>
                            </div>

...
@section('css')
    @toastr_css
@section('title')
    {{ trans('quizz-translation.edit_quizz') }} {{$quizz->name}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('quizz.update','test')}}" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="subject_id">{{ trans('quizz-translation.subject_name') }}:<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="teacher_id">{{ trans('quizz-translation.teacher_name') }}<span class="text-danger">*</span></label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="grade_id">{{trans('quizz-translation.grade_name')}} : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="classroom_id">{{trans('quizz-translation.class_name')}} : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="section_id">{{trans('quizz-translation.section_name')}} : </label>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ trans('quizz-translation.submit') }}</button>
                            </form>
                        </div>
                    </div>
                </div>

...
@section('css')
    @toastr_css
@section('title')
    {{ trans('question-translation.add_question') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('questions.store') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title"> {{ trans('question-translation.answer') }} <span style="color: red; font-size: smaller"> يجب فصل بعلامه - بين الاسئلة</span> </label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="score">
                                                <option selected disabled> {{ trans('question-translation.select_score') }} </option>

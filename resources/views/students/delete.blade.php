    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('student-translation.deleted_student')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('student.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('student-translation.deleted_student_title')}}</h5>

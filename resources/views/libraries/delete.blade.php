        ...
        <form action="{{route('library.destroy','test')}}" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> {{ trans('library-translation.warning_book') }} <span class="text-danger">{{$book->title}}</span></p>
                ...
                <div class="modal-footer">
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{ trans('library-translation.close') }}</button>
                        <button type="submit"
                                class="btn btn-danger">{{ trans('library-translation.submit') }}</button>
                    </div>
                </div>
            </div>
        </form>

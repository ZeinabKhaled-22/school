    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                {{-- <a class="dropdown-item" href="{{ route('logout') }}"><i class="text-danger ti-unlock"></i>{{ trans('main-translation.logout') }}</a> --}}
                                    ...
                                    <form method="GET" action="{{ route('logout','parent') }}">
                                        @else
                                            <form method="GET" action="{{ route('logout','web') }}">
                                                ...
                                                @csrf
                                                <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="bx bx-log-out"></i>{{ trans('main-translation.logout') }}</a>
                                            </form>
            </div>
        </li>
    </ul>

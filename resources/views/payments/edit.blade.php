...
@section('css')
    @toastr_css
@section('title')
  {{ trans('payment-translation.edit_payment') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
  {{ trans('payment-translation.edit_payment') }} : <label style="color: red">{{$payment_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('payment-translation.amount')}} : <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('payment-translation.description')}} : <span class="text-danger">*</span></label>
